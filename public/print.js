...
function buildPrintSvg(){
  ...
  const metadata=`<metadata>Generated by Cây Gia Phả Web v1.0.33. Vector layout for large-format printing. Physical size ${round(widthCm)}cm × ${round(heightCm)}cm.</metadata>`;
