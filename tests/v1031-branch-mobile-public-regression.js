...
assert.equal(pkg.version,'1.0.34','package.json phải ở v1.0.34');
...
for(const html of [index,gallery,contact,contributions]) assert.match(html,/styles\.css\?v=1\.0\.34/,'Trang công khai phải dùng cache key v1.0.34');
